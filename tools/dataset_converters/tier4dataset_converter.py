...
nus_categories = ('car', 'truck', 'bus', 'bicycle', 'pedestrian')
...
def create_tier4_infos(root_path,
    ...
    def process_scene(nusc, train_scenes, val_scenes, is_test=False):
        if not is_test:
            train_nusc_infos, val_nusc_infos = _fill_trainval_infos(
                nusc, train_scenes, val_scenes, False, max_sweeps=max_sweeps)
...
def _fill_trainval_infos(nusc,
    ...
    for idx, sample in enumerate(mmengine.track_iter_progress(nusc.sample)):
